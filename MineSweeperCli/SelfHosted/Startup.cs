...
{
    /// <summary>
    /// When using <see cref="GameController"/> as a self-hosted console application, use <see cref="Configure"/>
    ...
    /// </summary>
    /// <remarks>
    /// When using <see cref="GameController"/> as an in-memory component, your hosting application would typically
    ...
    class Startup
    {
        ...
        /// be passed to <see cref="GameController"/> 
        /// </summary>
        public static Settings Settings= new Settings();

        /// <summary>
        /// Initialise three things during application startup from the console.
        /// <i>(When using <see cref="GameController"/> as an in memory component, your hosting application would typically
        ...
        /// <paramref name="appSettingsSectionName"/>, which defaults to <c>nameof(<see cref="GameController"/>)</c>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            const string appSettingsSectionName = nameof(GameController);
